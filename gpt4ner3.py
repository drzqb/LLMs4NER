...
class MyDataset(Dataset):
    ...
    def __init__(self, tokenizer):
        ...
        prompt_prefix = "你是一个命名实体识别模型，请列出后面文本中类别为\"治疗\"、\"身体部位\"、\"症状和体征\"、\"检查和检验\"和 \"疾病和诊断\"的实体，实体与类别之间用\"_\"连接。文本："
        prompt_suffix = "实体有："
